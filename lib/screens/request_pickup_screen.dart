    ...
    try {
      ...
      String? photoUrl;
        if (_selectedImage != null) {
          print('🖼️ Ada gambar yang akan diupload');
          print('📂 File path: ${_selectedImage!.path}');
          
          setState(() => _isUploadingImage = true);
          
          photoUrl = await _cloudinaryService.uploadPickupImage(_selectedImage!);
          ...
          if (photoUrl == null) {
            print('❌ Upload gagal, photoUrl null');
          }
        } else {
                  ...
                  child: _selectedImage != null
                    ? ClipRRect(
                        ...
                        child: kIsWeb
                            ...
                            : Image.file(
                                File(_selectedImage!.path),  // Convert ke File di mobile
                                fit: BoxFit.cover,
                                width: double.infinity,
                              ),
                      )
